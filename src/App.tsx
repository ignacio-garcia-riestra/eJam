      ...
      <main className="flex flex-col w-full h-full px-[127px]">
        ...
        <div className="mt-[60px] flex flex-row ml[1px] justify-between">
          <div className="flex gap-5 items-center">
            <div className="flex bg-[#85BF55] h-10 w-10 rounded-full">
              <img src={tickCircle} alt="tick circle" className="mx-auto self-center" />
            </div>
            <span className="text-xl leading-[22px]">
              Step 1 : Cart Review
            </span>
          </div>
          <div className="flex gap-5 items-center">
          ...
          <div className="flex gap-5 items-center">
            <div className="flex bg-[#2C7EF8] h-10 w-10 rounded-full">
              <span className="text-xl text-white mx-auto self-center">
                3
              </span>
            </div>
        ...
        <div className="flex flex-row gap-10 bg-[#FAFAFA] w-full mt-10 mb-[61px] ml-[1px] p-10 rounded-[10px] shrink-0">
          <div className="flex flex-col">
            <img  src={clarifionImageFeatures} alt="clarifion image features" className="shrink-0"/>
          ...
          <div className="w-full flex flex-col gap-8">
            ...
            <div className="w-full flex gap-6">
              <img src={clarifionImageBackgroundBlue} alt="clarifion image background blue" 
              ...
              <div className="flex flex-col gap-[15px]">
                <div className="flex w-full justify-between h-4">
                  ...
                  <div className="flex gap-2.5 font-semibold items-center">
                    ...
                    <span className="text-[22px] text-[#2C7EF8]">
                      $84
                    </span>
                  </div>
                ...
                <div className="flex gap-0.5">
                  <img src={starRounded} alt="rounded stars" className="h-[18px]" />
                  <img src={starRounded} alt="rounded stars" className="h-[18px]" />
                  <img src={starRounded} alt="rounded stars" className="h-[18px]" />
                  <img src={starRounded} alt="rounded stars" className="h-[18px]" />
                  <img src={starRounded} alt="rounded stars" className="h-[18px]" />
            ...
            <div className="flex gap-4 -mt-2">
              <img src={satisfactionGuaranteeStamp} alt="satisfaction guarantee stamp" />

...
export default function Header() {
  return (
    <div className="bg-[#252F3D] shrink-0 flex flex-row w-full h-[42px] sm:h-[50px] pl-5 sm:pl-[127px] pr-5 sm:pr-[137px] text-white text-xs leading-3 font-medium items-center justify-between">
      ...
      <div className="hidden sm:flex flex-row h-[22px] items-center">
        ...
        <span className="ml-2 h-3">FREE DELIVERY ON ORDERS OVER $40.00</span>
      </div>
